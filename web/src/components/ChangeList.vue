...
const emit = defineEmits(['select', 'pin', 'toggle-review', 'stage', 'unstage', 'review-all', 'menu'])

/** 파일 행 우클릭 → 부모가 컨텍스트 메뉴를 연다. */
function onRowMenu(event, file) {
  event.preventDefault()
  emit('menu', { file, event })
}
